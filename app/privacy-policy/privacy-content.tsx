...
export default function PrivacyContent() {
  return (
    <main className="relative overflow-hidden bg-background">
      {/* ── HERO ──────────────────────────────────────────────────────────── */}
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 bg-grey-50 border-b border-grey-200">
        <div className="w-full max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <div className="mt-8 flex items-center gap-3 text-grey-400">
              <div className="w-10 h-10 rounded-full bg-peach-light flex items-center justify-center">
                <Shield className="w-5 h-5 text-ignite-orange" />
              </div>
        ...
        <div className="w-full max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="space-y-12">
              <section>
                <p className="text-body-lg leading-relaxed italic">
                  At Digiimark, your privacy is our priority. Our policy transparently explains how we collect, use, and protect your information while delivering innovative, custom-tailored digital marketing solutions that empower your brand.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-body leading-relaxed">
                  Digiimark (“we,” “us,” or “our”) is a creative agency dedicated to growing brands online. We provide full-service, custom-tailored online marketing strategies that increase brand awareness, drive conversions, and generate leads. This Privacy Policy explains how we collect, use, disclose, and protect your information when you access or use our website, digital platforms, and services (“Services”). By using our Services, you agree to the collection and use of information in accordance with this Privacy Policy.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="heading-h3 text-foreground mb-3">Personal Information:</h3>
                    <p className="text-body mb-4">When you interact with our website or engage with our Services, we may collect personally identifiable information (“Personal Information”) such as:</p>
                  ...
                  <div>
                    <h3 className="heading-h3 text-foreground mb-3">Non-Personal Information:</h3>
                    <p className="text-body mb-4">We also collect non-personal data, including but not limited to:</p>
                    <ul className="list-disc pl-6 space-y-2 text-body">
              ...
              <section>
                ...
                <p className="text-body mb-4">We use the collected information for several purposes, including:</p>
                <ul className="list-disc pl-6 space-y-2 text-body">
                  <li><strong className="text-foreground">Service Provision:</strong> To operate and improve our Services, tailor marketing strategies, and manage client relationships.</li>
                  ...
                  <li><strong className="text-foreground">Legal & Compliance:</strong> To comply with legal obligations, enforce our agreements, and protect the rights, property, or safety of Digiimark, our users, or others.</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-body mb-4">We do not sell your personal data. However, we may share your information with:</p>
                <ul className="list-disc pl-6 space-y-2 text-body">
                  ...
                  <li><strong className="text-foreground">Legal Requirements:</strong> When required by law, Digiimark may disclose your information to comply with legal obligations.</li>
              ...
              <section>
                ...
                <p className="text-body mb-4">We implement robust security measures to protect your data, including:</p>
                <ul className="list-disc pl-6 space-y-2 text-body">
                  <li>Data encryption both in transit and at rest.</li>
                  <li>Regular security assessments and monitoring.</li>
                  <li>Restricted access controls and authentication protocols.</li>
                </ul>
                <p className="text-body mt-4 italic">Note: while we strive to protect your personal information, no method of transmission over the internet is 100% secure.</p>
              </section>
              ...
              <section className="bg-grey-50 rounded-2xl p-8 border border-grey-200">
                <h2 className="heading-h3 text-foreground mb-4">11. Contact Information</h2>
                <p className="text-body mb-4">
                  If you have any questions, concerns, or requests regarding this Privacy Policy, please contact us at:
                </p>
                <a 
                  href="mailto:admin@digiimark.com" 
                  className="inline-flex items-center gap-2 text-ignite-orange font-medium hover:underline"
                >
                  admin@digiimark.com
                </a>
              </section>
