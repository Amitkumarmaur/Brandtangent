...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    category: "CRO",
    flag: "🇬🇧",
    title: "E-Commerce Shop — Conversion rate doubled from 1.2% to 2.6%",
    image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=85",
    stat: { value: "2.6%", label: "Conversion Rate" },
    accent: "#10B981",
  ...
  },
  {
    ...
    flag: "🇦🇺",
    title: "B2B Software — $4.80 cost-per-lead on LinkedIn Ads at scale",
    image: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=1200&q=85",
    stat: { value: "$4.80", label: "Cost Per Lead" },
    accent: "#8B5CF6",
...
// ── Word cycling ─────────────────────────────────────────────────
const WORDS = ["PROFITABLE", "SCALABLE", "CONVERTING", "REVENUE-DRIVEN"]
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <span className="font-heading text-ignite-orange text-sm font-medium tracking-wider uppercase">Growth & Revenue</span>
              </motion.div>
              ...
              >
                We build full-funnel revenue systems that capture leads, nurture prospects, and convert them into loyal clients — on autopilot.
              </motion.p>
            </div>
            ...
            <div className="flex items-end justify-between mt-12 flex-wrap gap-4">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9 }}>
                <p className="font-mono text-4xl md:text-5xl font-black text-white leading-none">
                  10M<span className="text-ignite-orange">+</span>
                </p>
                <p className="font-sans text-white/40 text-xs tracking-widest uppercase mt-2">Revenue Generated</p>
              </motion.div>
