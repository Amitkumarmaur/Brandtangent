...
const PROJECTS: Project[] = [
  {
    ...
    flag: "🇦🇪",
    title: "Enterprise Automation — Rescued 1,200 hours of manual data entry per month",
    image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&w=1200&q=85",
    stat: { value: "1.2K", label: "Hours Saved" },
    accent: "#FF5722",
  ...
  },
  {
    ...
    category: "AI Chatbot",
    flag: "🇺🇸",
    title: "Customer Support Agent — Handling 85% of queries fully autonomously",
    image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&w=1200&q=85",
    stat: { value: "85%", label: "Resolution Rate" },
    accent: "#3B82F6",
  ...
  },
  {
    ...
    flag: "🇬🇧",
    title: "Sales Forecast Model — 40% reduction in inventory waste",
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=85",
    stat: { value: "40%", label: "Waste Reduction" },
    accent: "#10B981",
  ...
  },
  {
    ...
    flag: "🇨🇦",
    title: "Internal Knowledge Base — Finding SOPs in seconds from a 10,000 document database",
    image: "https://images.unsplash.com/photo-1456324505273-21c52289c13e?auto=format&fit=crop&w=1200&q=85",
    stat: { value: "10K+", label: "Indexed Docs" },
    accent: "#8B5CF6",
...
// ── Word cycling ─────────────────────────────────────────────────
const WORDS = ["INTELLIGENT", "EFFICIENT", "AUTONOMOUS", "PREDICTIVE"]
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <span className="font-heading text-ignite-orange text-sm font-medium tracking-wider uppercase">AI & Automation</span>
              </motion.div>
              ...
              >
                We deploy intelligent agents and automated workflows to eliminate manual work and accelerate your business.
              </motion.p>
            </div>
            ...
            <div className="flex items-end justify-between mt-12 flex-wrap gap-4">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9 }}>
                <p className="font-mono text-4xl md:text-5xl font-black text-white leading-none">
                  250<span className="text-ignite-orange">+</span>
                </p>
                <p className="font-sans text-white/40 text-xs tracking-widest uppercase mt-2">Automations Built</p>
              </motion.div>
