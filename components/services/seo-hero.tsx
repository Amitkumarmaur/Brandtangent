...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    category: "AEO / GEO",
    flag: "🇨🇦",
    title: "Insurance Broker — Cited by ChatGPT & Perplexity as top recommendation",
    image: "https://images.unsplash.com/photo-1676911809779-5ce408f0cf26?auto=format&fit=crop&w=1200&q=85",
    stat: { value: "Top 1", label: "AI Citations" },
    accent: "#8B5CF6",
...
// ── Word cycling ─────────────────────────────────────────────────
const WORDS = ["RANKABLE", "DISCOVERABLE", "AUTHORITATIVE", "OPTIMIZED"]
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <span className="font-heading text-ignite-orange text-sm font-medium tracking-wider uppercase">SEO & Search Visibility</span>
              </motion.div>
              ...
              >
                We engineer long‑term organic growth through technical precision, content authority, and AI search readiness.
              </motion.p>
            </div>
            ...
            <div className="flex items-end justify-between mt-12 flex-wrap gap-4">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9 }}>
                <p className="font-mono text-4xl md:text-5xl font-black text-white leading-none">
                  180<span className="text-ignite-orange">+</span>
                </p>
                <p className="font-sans text-white/40 text-xs tracking-widest uppercase mt-2">Sites Ranked</p>
              </motion.div>
